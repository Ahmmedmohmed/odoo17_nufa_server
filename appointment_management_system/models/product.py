...
class Product(models.Model):
    ...
    def action_get_appointment_employee_slot(self, employee_id, date):
        ...
        slot_ids = self.env['appointment.employee.slot'].search([('employee_id', '=', employee_id), ('date', '=', date), ('state', '=', 'draft')])
    ...
    def action_create_appointment(self, partner_id, branch_id, employee_id, product_id, date, appointment_type, price, state):
        appointment_id = self.env['appointment.management'].create({
